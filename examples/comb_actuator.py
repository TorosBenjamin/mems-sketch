...
design.add(Instance("spring_l", "serpentine_spring", {"turns": 2}, x=-100, y=37))
design.add(Instance("spring_r", "serpentine_spring", {"turns": 2}, x=100, y=37))
design.add(Instance("anchor_l", "anchor", {"size": 40}, x=-100, y=118))
design.add(Instance("anchor_r", "anchor", {"size": 40}, x=100, y=118))
